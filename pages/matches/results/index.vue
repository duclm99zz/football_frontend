                ...
                <v-card-text>
                  ...
                  <h3 >
                    <span id="next-match-info">
                      ...
                      {{matchesCurrentMonth[0].home  + ' ' + matchesCurrentMonth[0].goalHome + '-' + matchesCurrentMonth[0].goalAway + ' ' + matchesCurrentMonth[0].away }} 
                    </span>
                  </h3>
...
#btn-match-center:hover {
  background-color: rgba(3, 84, 190, 0.945);
  border-style: none;
}
